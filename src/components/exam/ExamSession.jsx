    ...
    try {
      const res = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: 'user',
            content: `You are an expert NMCN nursing exam tutor. Explain the correct answer to this nursing exam question in a clear, educational way for a nursing student.
...
Be concise but thorough. Use proper medical terminology.`
      ...
      setAiExpl(data.content?.[0]?.text || 'AI explanation unavailable.');
    } catch (e) {
