...
export default function DailyPracticePage() {
  ...
  const [activeTab,  setActiveTab]  = useState('all'); // 'all' | 'today' | 'done'
    ...
    <div style={{ padding: '24px', maxWidth: 900 }}>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: 14, margin: 0 }}>
          New quizzes every day — all previous ones stay available forever. Never miss a day of practice.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div style={styles.emptyState}>
          ...
          <div style={{ color: 'var(--text-muted)', fontSize: 14 }}>
            {activeTab === 'today'
              ? "Today's quiz hasn't been posted yet. Check back soon!"
              : activeTab === 'done'
